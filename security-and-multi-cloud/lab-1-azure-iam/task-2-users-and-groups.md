...
2. 아래 두 계정을 만듭니다. 암호는 **자동 생성**을 쓰고 반드시 메모하세요 (첫 로그인 시 변경 요구됨).
...
<tr>
<td>dev-user**</td>
<td>dev-user**@테넌트도메인.onmicrosoft.com</td>
<td>Task 3~4에서 기여자 역할 부여</td>
</tr>
<tr>
<td>view-user**</td>
<td>view-user**@테넌트도메인.onmicrosoft.com</td>
<td>Task 4~5에서 읽기 권한자 역할 부여</td>
</tr>
</table>
...
>
> ⚠️ **동적 그룹**('부서가 영업이면 자동 포함' 같은 규칙으로 멤버가 자동 갱신)은 **P1 등급이 필요**합니다. 멤버 자격 유형에서 '동적 사용자'를 고를 수 없다면 라이선스 때문입니다 (Task 1-3 참고).
