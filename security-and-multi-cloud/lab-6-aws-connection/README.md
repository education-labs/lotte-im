...
Lab 6은 앞 Lab의 설정이 전부 맞물려야 통신이 됩니다. **시작하기 전에 세 가지를 눈으로 확인하세요.** 특히 ①은 *이전 Lab 화면으로 되돌아가는 단계*라 가장 많이 빠집니다.
...
<tr>
<td>①★</td>
<td>피어링 <b>게이트웨이 전송</b> 두 체크박스<br>(허브 「전달하도록 허용」 → 스포크 「원격 게이트웨이 사용」)</td>
<td>Lab 5 Task 1 「배포 완료 후」</td>
<td><b>터널 UP · 양방향 바이트도 증가 · 그런데 ping 실패</b><br>(돌아온 패킷이 스포크를 못 찾고 게이트웨이에서 버려짐)</td>
</tr>
<tr>
<td>②</td>
<td>VPN 종류가 <b>경로 기반</b>, 활성-활성 <b>사용</b></td>
<td>Lab 3 Task 2</td>
<td>정책 기반이면 AWS 연결 자체가 불가 (45분 재배포)</td>
</tr>
<tr>
<td>③</td>
<td>게이트웨이 상태 <b>성공</b> + <b>공용 IP 2개 메모</b></td>
<td>Lab 5 Task 1</td>
<td>Task 1의 CGW에 넣을 값이 없음</td>
</tr>
</table>
...
<td>3</td>
<td>🟦 Azure</td>
<td>LNG 생성 + Lab 5 게이트웨이에 연결 추가</td>
<td>← 터널 외부 IP · PSK</td>
<td>—</td>
</tr>
<tr>
