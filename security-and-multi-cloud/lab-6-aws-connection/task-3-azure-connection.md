...
>
> ⚠️ **게이트웨이를 새로 만들지 않습니다.** Lab 5에서 만든 `vgw-hub-user**`에 **연결(Connection)을 하나 더 추가**하는 작업입니다.

```
vgw-hub-krc-prod-user**  (Lab 5에서 만든 게이트웨이 — 그대로 사용)
   ├─ 연결 ①  conn-to-onprem-user**      → lng-onprem-user**  (선택 사항 · Lab 5 Task 2)
...
2. 리소스 그룹 `rg-user**`, 이름 `lng-aws-vpc-user**`, 지역 `Korea Central` 입력.\
   엔드포인트 **IP 주소** → **③번 값(AWS 터널 1 외부 IP)** 입력.\
   주소 공간에 **`172.16.**.0/24`**(AWS VPC 대역) 입력
...
3. BGP: 사용 안 함 → \[검토 + 만들기] → \[만들기]

<figure><img src="../../.gitbook/assets/image (2).png" alt="" width="375"><figcaption></figcaption></figure>

<table><thead><tr><th width="169.09088134765625">항목</th><th width="225.6363525390625">값</th><th>출처</th></tr></thead><tbody><tr><td>이름</td><td>lng-aws-vpc-user**</td><td>—</td></tr><tr><td>IP 주소</td><td>③ AWS 터널 1 외부 IP</td><td>Task 2에서 메모 ★</td></tr><tr><td>주소 공간</td><td>172.16.**.0/24</td><td>AWS VPC 대역</td></tr></tbody></table>
...
2. 이름 `conn-azure-to-aws-user**`, 연결 형식 **사이트 간(IPsec)** 선택

<figure><img src="../../.gitbook/assets/image (1140).png" alt="" width="361"><figcaption></figcaption></figure>
