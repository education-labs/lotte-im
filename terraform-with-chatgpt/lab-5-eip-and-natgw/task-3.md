...
3. GenAI 에게 vars 파일 활용하도록 .tfvars (파일명은 예시) 파일 생성
...
**AZ별 NAT Gateway 이중화**: `public-c`에도 NAT Gateway를 하나 더 만들고, AZ별로 별도의 프라이빗 라우팅 테이블을 두어 같은 AZ의 NAT Gateway를 쓰도록 구성해보세요.
{% endhint %}
